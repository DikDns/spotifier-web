    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <motion.figcaption
              className="flex max-w-[400px] flex-row items-center text-lg font-medium dark:text-white"
              initial={{ y: -20 }}
              animate={{ y: 0 }}
              transition={{ delay: 0.4 }}
            >
              <motion.span className="text-wrap text-sm sm:text-lg">
                {name}
              </motion.span>
            ...
            <motion.p
              className="max-w-[400px] text-wrap text-sm font-normal dark:text-white/60"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
